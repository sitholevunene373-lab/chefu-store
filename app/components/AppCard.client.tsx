...
export function AppCard({ app, onInstall, showInstallButton = false }: AppCardProps) {
  ...
  return (
    ...
    >
      <Link href={`/app/${app.id}`}>
        <Card className="h-full cursor-pointer overflow-hidden border bg-card hover:bg-accent/50 hover:border-primary/30 transition-all duration-200">
