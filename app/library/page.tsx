        ...
        {installedApps.length > 0 ? (
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      <Link href={`/app/${app.id}`}>
                        <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center flex-shrink-0 cursor-pointer hover:bg-primary/15 transition-colors">
                          <span className="text-3xl">{app.icon}</span>
                        </div>
                      </Link>

                      <Link href={`/app/${app.id}`} className="flex-1 min-w-0 cursor-pointer">
          ...
          <Card>
            <CardContent className="p-12 text-center">
              <h3 className="mb-2 font-medium">No apps installed yet</h3>
              <p className="text-muted-foreground mb-4">
                Start by browsing and installing apps from our store.
              </p>
              <Link href="/browse">
